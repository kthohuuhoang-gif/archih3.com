...
(function () {
    ...
    // Wait for Phaser scenes to be registered (game đã new Phaser.Game(config) ở trên)
    ...
    function patchScene1() {
        ...
        const originalStartAudition = Scene1.prototype.startAuditionMode;
        Scene1.prototype.startAuditionMode = function () {
        ...
        const originalStartTool = Scene1.prototype.startToolMode;
        Scene1.prototype.startToolMode = function () {
            hideVDPad();
            return originalStartTool.apply(this, arguments);
        };

        // Patch triggerCrashEvent → hide D-Pad (Phase 1 → Crash event → Clone Stamp scene)
        if (Scene1.prototype.triggerCrashEvent) {
            const originalCrash = Scene1.prototype.triggerCrashEvent;
            Scene1.prototype.triggerCrashEvent = function () {
                hideVDPad();
    ...
    // ---------- 4. Disable iOS double-tap zoom on document (extra safety) ----------
    let lastTouchEnd = 0;
